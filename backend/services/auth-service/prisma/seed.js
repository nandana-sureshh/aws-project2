...
async function main() {
    ...
    // ------------------------------------------------------------------
    const adminPassword = await bcryptjs_1.default.hash('Admin@123', SALT_ROUNDS);
    ...
    // 2. Demo doctor 1
    // ------------------------------------------------------------------
    const doctorPassword = await bcryptjs_1.default.hash('Doctor@123', SALT_ROUNDS);
    ...
    // 4. Demo patients
    // ------------------------------------------------------------------
    const patientPassword = await bcryptjs_1.default.hash('Patient@123', SALT_ROUNDS);
